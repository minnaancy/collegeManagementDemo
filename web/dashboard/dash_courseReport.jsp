          ...
          <div class="login" style="width:80vw">              
            <form action="" class="coursereport">
                ...
                <table id="myTable">
                    ...
                    String str="select c2.coursename,c2.duration,d.deptname,c2.courseid from course c2 inner join department d on c2.deptid = d.deptid order by c2.coursename";
                    ...
                    <tr>
                        ...
                        <td> 
                             ...
                             <div>   <a href="../Action/courseReportaction.jsp?id=<%=rs.getInt(4)%>&action=e">Edit</a></div>
                            <div>   <a href="../Action/courseReportaction.jsp?id=<%=rs.getInt(4)%>&action=d">Delete</a></div>
                        </td>
